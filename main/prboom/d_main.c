...
static void D_DoomMainSetup(void)
{
  ...
  /* Work around BSS corruption during R_Init on ESP32-P4.
   * Something (likely cache/DMA related) overwrites the visplanes
   * static array during texture/patch init. Reset it here. */
  R_ResetVisplanes();
